...
```text
1. [1 주차] SU진로코칭2_대학일자리플러스센터 서비스 안내(1) [25분 0초]
2. [2 주차] SU진로코칭2_우리 전공과 진로 [25분 0초]
```

메뉴 `4`, `6`, `7`의 과제 목록은 과제 제목 안의 `11주차`, `[11주차]` 같은 패턴을 `[11 주차]` 형식으로 정리합니다. 제목에서 주차를 찾지 못하면 기존 제목을 그대로 표시합니다.
